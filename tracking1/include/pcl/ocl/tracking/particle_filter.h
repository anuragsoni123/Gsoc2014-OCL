#ifndef PCL_TRACKING_PARTICLE_FILTER_CL_H_
#define PCL_TRACKING_PARTICLE_FILTER_CL_H_
  ...
  namespace tracking
  {
    ...
    class ParticleFilterTracker: public Tracker<PointInT, StateT>
    {
      ...
      protected:
        ...
        pcl::ocl::PassThrough<PointInT> pass_x_;
        /** \brief Pass through filter to crop the pointclouds within the hypothesis bounding box. */
        pcl::ocl::PassThrough<PointInT> pass_y_;
        /** \brief Pass through filter to crop the pointclouds within the hypothesis bounding box. */
        pcl::ocl::PassThrough<PointInT> pass_z_;
