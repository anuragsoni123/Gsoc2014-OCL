#ifndef PCL_TRACKING_IMPL_PARTICLE_FILTER_CL_H_
#define PCL_TRACKING_IMPL_PARTICLE_FILTER_CL_H_
...
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::initCompute ()
{
...
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::sampleWithReplacement
...
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::genAliasTable (std::vector<int> &a, std::vector<double> &q,
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::initParticles (bool reset)
{
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::normalizeWeight ()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::cropInputPointCloud (
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::calcBoundingBox (
    double &x_min, double &x_max, double &y_min, double &y_max, double &z_min, double &z_max)
{
  ...
  {
    cl::Buffer buf_cloud(ocl->getContext(), CL_MEM_READ_WRITE, sizeof(PointT) * transed_reference_vector_[i]->points.size(), NULL);
    ocl->getQueue().enqueueWriteBuffer(buf_cloud, CL_TRUE, 0, sizeof(PointT) * transed_reference_vector_[i]->points.size(), const_cast<float*> (&transed_reference_vector_[i]->points[0].x), NULL);
    
    cl_float3 min, max;
    std::string PointFields = pcl::getFieldsList(*transed_reference_vector_[i]);
    get_min_max(buf_cloud, min, max, transed_reference_vector_[i]->points.size(),PointFields);
...
template <typename PointInT, typename StateT> bool
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::testChangeDetection
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::weight ()
{
  if (!use_normal_)
  {
    for (size_t i = 0; i < particles_->points.size (); i++)
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::computeTransformedPointCloud
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::computeTransformedPointCloudWithoutNormal
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::computeTransformedPointCloudWithNormal (
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::resample ()
{
  resampleWithReplacement ();
}

template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::resampleWithReplacement ()
{
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::update ()
{
...
template <typename PointInT, typename StateT> void
pcl::ocl::tracking::ParticleFilterTracker<PointInT, StateT>::computeTracking ()
{
...
#define PCL_INSTANTIATE_ParticleFilterTrackerOCL(T,ST) template class PCL_EXPORTS pcl::ocl::tracking::ParticleFilterTracker<T,ST>;
