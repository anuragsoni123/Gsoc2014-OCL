#ifndef PCL_TRACKING_IMPL_TRACKING_CL_H_
#define PCL_TRACKING_IMPL_TRACKING_CL_H_
...
namespace ocl
 {
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYZRPY : public _ParticleXYZRPY
    {
      ...
      static pcl::ocl::tracking::ParticleXYZRPY
      toState (const Eigen::Affine3f &trans)
      {
        ...
        return pcl::ocl::tracking::ParticleXYZRPY (trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw);
      }
    ...
    // a * k
    inline pcl::ocl::tracking::ParticleXYZRPY operator * (const ParticleXYZRPY& p, double val)
    {
      pcl::ocl::tracking::ParticleXYZRPY newp;
    ...
    // a + b
    inline pcl::ocl::tracking::ParticleXYZRPY operator + (const ParticleXYZRPY& a, const ParticleXYZRPY& b)
    {
      pcl::ocl::tracking::ParticleXYZRPY newp;
      newp.x = a.x + b.x;
      newp.y = a.y + b.y;
 ...
 namespace ocl
 {
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYZR : public _ParticleXYZR
    {
      ...
      static pcl::ocl::tracking::ParticleXYZR
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl::ocl::tracking::ParticleXYZR (trans_x, trans_y, trans_z, 0, trans_pitch, 0));
      }
    ...
    // a * k
    inline pcl::ocl::tracking::ParticleXYZR operator * (const ParticleXYZR& p, double val)
    {
      pcl::ocl::tracking::ParticleXYZR newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl::ocl::tracking::ParticleXYZR operator + (const ParticleXYZR& a, const ParticleXYZR& b)
    {
      pcl::ocl::tracking::ParticleXYZR newp;
      newp.x = a.x + b.x;
      newp.y = a.y + b.y;
 ...
 namespace ocl
 {
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYRPY : public _ParticleXYRPY
    {
      ...
      static pcl::ocl::tracking::ParticleXYRPY
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl::ocl::tracking::ParticleXYRPY (trans_x, 0, trans_z, trans_roll, trans_pitch, trans_yaw));
      }
    ...
    // a * k
    inline pcl::ocl::tracking::ParticleXYRPY operator * (const ParticleXYRPY& p, double val)
    {
      pcl::ocl::tracking::ParticleXYRPY newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl::ocl::tracking::ParticleXYRPY operator + (const ParticleXYRPY& a, const ParticleXYRPY& b)
    {
      pcl::ocl::tracking::ParticleXYRPY newp;
      newp.x = a.x + b.x;
      newp.y = 0;
 ...
 namespace ocl
 {
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYRP : public _ParticleXYRP
    {
      ...
      static pcl::ocl::tracking::ParticleXYRP
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl::ocl::tracking::ParticleXYRP (trans_x, 0, trans_z, 0, trans_pitch, trans_yaw));
      }
    ...
    // a * k
    inline pcl::ocl::tracking::ParticleXYRP operator * (const ParticleXYRP& p, double val)
    {
      pcl::ocl::tracking::ParticleXYRP newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl::ocl::tracking::ParticleXYRP operator + (const ParticleXYRP& a, const ParticleXYRP& b)
    {
      pcl::ocl::tracking::ParticleXYRP newp;
      newp.x = a.x + b.x;
      newp.y = 0;
 ...
 namespace ocl
 {
  namespace tracking
  {
    ...
    struct EIGEN_ALIGN16 ParticleXYR : public _ParticleXYR
    {
      ...
      static pcl::ocl::tracking::ParticleXYR
      toState (const Eigen::Affine3f &trans)
      {
        float trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw;
        getTranslationAndEulerAngles (trans,
                                      trans_x, trans_y, trans_z,
                                      trans_roll, trans_pitch, trans_yaw);
        return (pcl::ocl::tracking::ParticleXYR (trans_x, 0, trans_z, 0, trans_pitch, 0));
      }
    ...
    // a * k
    inline pcl::ocl::tracking::ParticleXYR operator * (const ParticleXYR& p, double val)
    {
      pcl::ocl::tracking::ParticleXYR newp;
      newp.x     = static_cast<float> (p.x * val);
      newp.y     = static_cast<float> (p.y * val);
      newp.z     = static_cast<float> (p.z * val);
      newp.roll  = static_cast<float> (p.roll * val);
    ...
    // a + b
    inline pcl::ocl::tracking::ParticleXYR operator + (const ParticleXYR& a, const ParticleXYR& b)
    {
      pcl::ocl::tracking::ParticleXYR newp;
      newp.x = a.x + b.x;
      newp.y = 0;
...
#define PCL_STATE_POINT_TYPES \
  (pcl::ocl::tracking::ParticleXYR) \
  (pcl::ocl::tracking::ParticleXYZRPY) \
  (pcl::ocl::tracking::ParticleXYZR) \
  (pcl::ocl::tracking::ParticleXYRPY) \
  (pcl::ocl::tracking::ParticleXYRP)
