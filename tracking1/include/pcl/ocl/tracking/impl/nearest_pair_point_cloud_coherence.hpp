#ifndef PCL_TRACKING_IMPL_NEAREST_PAIR_POINT_CLOUD_COHERENCE_CL_H_
#define PCL_TRACKING_IMPL_NEAREST_PAIR_POINT_CLOUD_COHERENCE_CL_H_
...
#define PCL_INSTANTIATE_NearestPairPointCloudCoherenceOCL(T) template class PCL_EXPORTS pcl::ocl::tracking::NearestPairPointCloudCoherence<T>;
