#ifndef PCL_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_FILTER_CL_H_
#define PCL_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_FILTER_CL_H_

#include <pcl/ocl/tracking/kld_adaptive_particle_filter.h>

template <typename PointInT, typename StateT> bool
pcl::ocl::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::initCompute ()
{
...
template <typename PointInT, typename StateT> bool
pcl::ocl::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::insertIntoBins
...
pcl::ocl::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::resample ()
{
  unsigned int k = 0;
  unsigned int n = 0;
...
#define PCL_OCL_INSTANTIATE_KLDAdaptiveParticleFilterTracker(T,ST) template class PCL_EXPORTS pcl::ocl::tracking::KLDAdaptiveParticleFilterTracker<T,ST>;
